...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='ucf101', split='train', clip_len=16, preprocess=False):
        ...
        if dataset == "ucf101":
            if not os.path.exists('/home/zlj/PycharmProjects/py_torch/dataloaders/ucf_labels.txt'):
                with open('/home/zlj/PycharmProjects/py_torch/dataloaders/ucf_labels.txt', 'w') as f:
