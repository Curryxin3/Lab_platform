...
def init():
    ...
    # class_names = sorted(['Skirt','Top','Jeans','Joggers','Hoodie','Sweatpants','Coat','Sweatshorts','Capris','jeans'])
...
def train_model():
    ...
    train_data = []
    for index, btl_name in enumerate(btl_train_names): # total:42883
