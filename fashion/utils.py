...
def display_bbox_text(img, bbox, text):
    ...
    font = ImageFont.truetype('D:/Python/Projects/DeepFashion-master1/DeepFashion-master/fonts/alterebro-pixel-font.ttf', 30)
    #font = ImageFont.truetype('/usr/share/fonts/truetype/ubuntu-font-family/Ubuntu-C.ttf', 16)
    #font = ImageFont.truetype("/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", 16)
    #font = ImageFont.truetype('D:/Python/Projects/DeepFashion-master1/DeepFashion-master/font/Ubuntu-C.ttf', 16)
...
def crop_bbox(image_path_name, bboxes):
    ...
    for index, bbox in enumerate(bboxes):
        ...
        img_crop.save('D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/dataset_prediction/crops/' + img_crop_name)
