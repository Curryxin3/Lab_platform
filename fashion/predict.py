...
def init():
    ...
    class_names = ['Anorak',  'Jodhpurs',   'Sweatpants', 'Sarong', 'Capris', 'Robe', 'Gauchos', 'Turtleneck', 'Kaftan']
    #class_names = get_subdir_list(dataset_train_path)
    logging.debug('class_names {}'.format(class_names))


def get_images():
    #prediction_dataset_path='dataset_prediction/'
    #images_path_name = 'fashion/dataset_prediction/images/\\Fashion-1-60.jpg'
    images_path_name = sorted(glob.glob('D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/dataset_prediction/images/' + '\Fashion-1-60.jpg'))
...
def predict_model(images, images_names=None):
    ...
    ## Folder
    prediction_dataset_path='D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/dataset_prediction/'
    ...
    for index, image in enumerate(images_names):
        logging.debug('\n\n++++++++++++++++++++++++++++++++++++++++')
        image_path_name = prediction_dataset_path + 'crops/' + image
    ...
    for image_path_name in images_name_list:
        bbox_=image_path_name.split('/')[-1].split('.jpg')[0].split('-')[3]
    ...
    orig_image_path_name = sorted(glob.glob('D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/dataset_prediction/images' + '\Fashion-1-60.jpg'))
...
def Pred(filename):
    ...
    #filename = 'D:/Python/Projects/DeepFashion-master1/v_TaiChi_g04_c01.avi'
