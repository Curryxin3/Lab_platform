...
category_name_generate=['Anorak',  'Jodhpurs',   'Sweatpants', 'Sarong', 'Capris', 'Robe', 'Gauchos', 'Turtleneck', 'Kaftan']
            ...
            with open(fashion_dataset_path + '/Eval/list_eval_partition.txt', 'r') as file_list_eval_ptr:
                ...
                for line in file_list_category_img:
                    ...
                    if image_category_index < max_categories:
                        ...
                        image_path_name_src = os.path.join(fashion_dataset_path, 'Img/img', image_path_name)
