...
fashion_dataset_path='/media/HardDisk/Category and Attribute Prediction Benchmark/'
...
top_model_weights_path_save = 'D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/output/bottleneck_fc_model.h5'
#top_model_weights_path_load = 'output/bottleneck_fc_model.h5'
top_model_weights_path_load = 'D:/Python/Projects/pyqt5_V4.0/pyqt5_V4.0/fashion/output/best-weights-007-1.2227.hdf5'
...
logs_path_name='logs'
output_path_name='fashion/output/'
...
prediction_class_prob_threshold = 0.05
prediction_iou_threshold = 0.05
